...
- What the tests pin (94 offline total, this file's share 9, + 10 live, all actually run)
- Production deltas
...
|---|---|---|---|
| Offline pure logic | `tests/smoke_test.py` checks 19-27 | bare interpreter | 9/9 this file's share (94/94 whole file) |
