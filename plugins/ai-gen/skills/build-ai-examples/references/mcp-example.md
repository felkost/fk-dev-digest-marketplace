...
- What the tests pin (73 offline total, this file's share 9, + 10 live, all actually run)
- Production deltas
...
`python tests/smoke_test.py` has 73 checks total, all six examples this plugin ships;
...
|---|---|---|---|
| Offline pure logic | `tests/smoke_test.py` checks 19-27 | bare interpreter | 9/9 this file's share (73/73 whole file) |
