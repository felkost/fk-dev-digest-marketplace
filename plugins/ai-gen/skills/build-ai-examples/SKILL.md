...
- **Не приписувати провайдеру можливостей, яких він не документує.** OpenRouter — це chat
  completions; ендпоінта ембедингів він не документує, тож RAG-приклад бере ембединги в
  окремого OpenAI-сумісного провайдера (за замовчуванням локального). Перевіряти в чинному
  API-довіднику провайдера, а не з пам'яті.
