# Rebuild the ChatGPT Custom GPT knowledge package for the ai-gen skills.
# Run this after any change to skills/*/references or skills/*/SKILL.md.
# See chatgpt/README.md for the full install/update workflow.

$ErrorActionPreference = "Stop"

$root = Split-Path -Parent $PSScriptRoot   # ai-gen/ (this script lives in ai-gen/chatgpt/)
...
# 2. Stage exactly what the GPT needs: SKILL.md + references/ per skill. Excluded on purpose:
...
$stage = Join-Path $env:TEMP "ai_gen_knowledge_stage"
...
# 3. Zip it.
$knowledgeZip = Join-Path $dist "ai_gen_knowledge.zip"
