...
- Прогноз часових рядів: ARIMA/ETS/global ML/TimesFM zero-shot; переміжний попит; яка метрика → ml-forecasting-model (наївна база; ADF+KPSS протилежні; rolling-origin; MAPE→MASE/RMSSE; Tweedie; покриття квантилів міряти).
