# CLAUDE.md — agent-ml-interviewer
...
- Skill content (`SKILL.md` bodies, `references/`, `README.md`, `HANDOFF.md`) is written in
  Ukrainian by design. See "Note on Ukrainian-language plugins" in the repo root `README.md` —
  this plugin is quarantined from the marketplace's English-only content checks in
  `scripts/validate-marketplace.mjs`, not translated. Don't translate it unprompted.
