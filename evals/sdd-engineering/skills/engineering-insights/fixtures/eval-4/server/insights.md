...
## Quirks
- **2026-06-18 [Quirk]** — `fastify-type-provider-zod` compiles each route's reply schema once at boot, so editing a reply schema requires a full server restart; watch-mode reload does not recompile it. `server/src/modules/reviews/routes.ts:67`

## Open Questions
<!-- Unresolved. -->

---
Last updated: 2026-06-18 · Entries: 1
