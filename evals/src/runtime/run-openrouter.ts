 ...
 *
 * This mirrors a typical OpenAI-SDK-against-OpenRouter integration but returns free text instead
 * of structured JSON, which is what the skill-quality judge scores.
 *
